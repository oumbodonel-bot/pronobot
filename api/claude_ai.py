...
4. VALUE: probabilité_estimee - probabilité_implicite. 
...
- Privilégie la fiabilité.
- ACCEPTE une value négative (jusqu'à -5%) si la confiance est élevée (3+) ou si le signal Pinnacle est MODERE/FORT.
- Ne rejette que les matchs réellement incohérents ou avec un signal Pinnacle très négatif.

VIP (Cote cible: 1.40-2.00):
- Recherche la meilleure opportunité.
- ACCEPTE une value négative (jusqu'à -3%) si les autres indicateurs (confiance, signal Pinnacle, alignement marché) sont favorables.
- Sois moins strict que précédemment pour assurer une présence de matchs.

MONTANTE (Cote cible: 1.20-1.50):
- Reste la seule catégorie très stricte.
- Sécurité maximale obligatoire. Exige une value proche de 0% ou positive.
