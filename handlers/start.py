...
from core.database import create_or_update_user, get_user, update_user_language, is_vip, is_basic
...
def _main_menu_keyboard(lang: str, vip: bool = False, basic: bool = False):
    ...
    basic_badge = " 💛" if (basic or vip) else " 🔒"

    return InlineKeyboardMarkup([
        [InlineKeyboardButton(t("btn_free_prono",   lang),               callback_data="free_prono")],
        [InlineKeyboardButton(t("btn_vip_pronos",   lang) + basic_badge, callback_data="vip_pronos")],
        [
